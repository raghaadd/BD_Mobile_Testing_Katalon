...
Mobile.tap(findTestObject('Object Repository/android.widget.Button - START WITH THIS DESIGN'), 0)

Mobile.tap(findTestObject('Object Repository/android.widget.EditText - ballarddesigns.com'), 0)

Mobile.setText(findTestObject('Object Repository/android.widget.EditText - Search or type URL'), 'https://www.ballarddesigns.com/oval-back-louis-xvi-side-chair/712721?listIndex=1&uniqueId=712721&isNewProduct=false', 
    0)
...
Mobile.tap(findTestObject('Object Repository/android.widget.Button - 4 ITEMS IN THE CART'), 0)
...
Mobile.tap(findTestObject('Object Repository/android.widget.Button - Remove'), 0)
