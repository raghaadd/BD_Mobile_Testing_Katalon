...
Mobile.setText(findTestObject(''), 'https://www.ballarddesigns.com/isabella-blue-fabric-by-the-yard/461813?searchTerm=FF016ISU', 
    0)

Mobile.tap(findTestObject('Object Repository/android.widget.Button - Increase'), 0)

Mobile.tap(findTestObject('Object Repository/android.widget.Button - Add to Cart'), 0)

Mobile.tap(findTestObject('Object Repository/android.widget.Button - 2 ITEMS IN THE CART'), 0)
